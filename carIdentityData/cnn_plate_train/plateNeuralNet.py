...
if __name__ == '__main__':
    cur_dir = sys.path[0]
    data_dir = os.path.join(cur_dir, 'D:\CarPlateIdentity\carIdentityData\cnn_plate_train\plate_train')
    test_dir = os.path.join(cur_dir, 'D:\CarPlateIdentity\carIdentityData\cnn_plate_train\plate_test')
    train_model_path = os.path.join(cur_dir, 'D:\CarPlateIdentity\carIdentityData\model\plate_recongnize\model.ckpt')
    model_path = os.path.join(cur_dir,'D:\CarPlateIdentity\carIdentityData\model\plate_recongnize\model.ckpt-520')
